				...
				<div id="member">
					...
					<div class="informbox">
						<div class="inform">
							...
							%>
							<ul>
								<li><input type="text" class="loginType" value="<%= ck_id %>" onfocus="this.className='mfocus'" onblur="if (this.value.length==0) {this.className='loginType'}else {this.className='mfocusnot'}" style="ime-mode:inactive;" /></li>
							...
							<div class="chk"><input type="checkbox" name="idsave" id="idsave"/<% if(!ck_id.equals("")){ %>checked<%} %>><label for="idsave">아이디 저장</label></div>							
